...
$comment_tag_query = "SELECT * FROM comment";
$users_tag_query = "SELECT * FROM users";
$posts_tag_query = "SELECT * FROM post";
$posts_tag_query = "SELECT * FROM add_place";
...
$place_tag_run = mysqli_query($con, $posts_tag_query);
...
$place_rows = mysqli_num_rows($place_tag_run);
?>
  </head>
  <body>
    <div id="wrapper">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9">
                                            <div class="text-right huge"><?php echo $place_rows;?></div>
                                            <div class="text-right">New Places</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="place.php">
                                    <div class="panel-footer">
                                        <span class="pull-left">View All Places</span>
                                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                        <div class="clearfix"></div>
                                    </div>
                                </a>
